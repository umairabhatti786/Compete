...
export const CashPrizesData = [
  {
    id: 1,
    price: '$25.00',
    des: 'Tournament Registration',
    title: 'Summer Cup',
    tournament: true,
    team: false,
  },
...
export const YourTournamentsData = [
  {
    title: 'Upcoming',
    data: [
      {
        id: 1,
        ClubLogo: images.tournaments_img5,
        ClubTitle: 'FC Barcelona vs. Real Madrid',
        ClubTeam: '1st Half',
      },
      {
        id: 2,
        ClubLogo: images.tournaments_img4,
        ClubTitle: 'FC Barcelona vs. Real Madrid',
        ClubTeam: '1st Half',
      },
    ],
  },
  {
    ...
    data: [
      {
        id: 1,
        ClubLogo: images.tournaments_img3,
        ClubTitle: 'FC Barcelona vs. Real Madrid',
        ClubTeam: '1st Half',
      },
      {
        id: 2,
        ClubLogo: images.tournaments_img2,
        ClubTitle: 'FC Barcelona vs. Real Madrid',
        ClubTeam: '1st Half',
      },
    ],
  },
  {
    ...
    data: [
      {
        id: 1,
        ClubLogo: images.tournaments_img1,
        ClubTitle: 'FC Barcelona vs. Real Madrid',
        ClubTeam: '1st Half',
      },
    ],
...
export const LiveMatcheDate: ClubDataType[] = [
  {
    id: 1,
    ClubLogo: images.league_cup,
    ClubTitle: 'FC Barcelona vs. Real Madrid',
    ClubTeam: '1st Half',
  },
  {
    id: 2,
    ClubLogo: images.champions_cup,
    ClubTitle: 'Manchester United vs. Liverpool',
    ClubTeam: '2nd Half',
  },
  {
    id: 3,
    ClubLogo: images.world_cup_qualifier,
    ClubTitle: 'Juventus vs. AC Milan',
    ClubTeam: '1st Half',
  },
  {
    id: 4,
    ClubLogo: images.league_cup,
    ClubTitle: 'Bayern Munich vs. Borussia Dortmund',
    ClubTeam: '2nd Half',
  },
  {
    id: 5,
    ClubLogo: images.champions_cup,
    ClubTitle: 'Paris Saint-Germain vs. Olympique de',
    ClubTeam: '1st Half',
  },
  {
    id: 6,
    ClubLogo: images.world_cup_qualifier,
    ClubTitle: 'Chelsea vs. Arsenal',
    ClubTeam: '2nd Half',
  },
];
...
export const ArchivedTournamentsData: ClubDataType[] = [
  {
    id: 1,
    ClubLogo: images.match_stadium,
    ClubTitle: 'Premier League',
    ClubTeam: '2023 Season',
  },
  {
    id: 2,
    ClubLogo: images.football_img2,
    ClubTitle: 'Champions League',
    ClubTeam: '2022 Season',
  },
  {
    id: 3,
    ClubLogo: images.football_img1,
    ClubTitle: 'World Cup',
    ClubTeam: '2021 Season',
  },
];
